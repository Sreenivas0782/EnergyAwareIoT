...
to get the performance metrics when used as a Wi-Fi with the IEEE 802.11 standard

$ ./ns3 run scratch/ee-iot-wpan.cc 

to get the performance metrics when used as a Wireless Personal Area Network (IEEE 802.15.4- IOT) with IEEE 802.15.4 standard
